...
const authenticate = require('../authenticate'); // tokenize some shit
...
router.post('/login', cors.corsWithOptions, passport.authenticate('local'), (req, res) => { // is the user already logged in? passport allows us to remove ALL the previous code here, check git history
