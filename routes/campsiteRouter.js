...
.delete(authenticate.verifyUser, authenticate.verifyAdmin, (req, res, next) => { // note: this is super dangerous and in the real world needs to be limited to only priviledged users
    Campsite.deleteMany()
    .then(response => {
        res.statusCode = 200;
        res.setHeader('Content-Type', 'application/json');
